...
void complex_to_sample(complex float * X, 
		       sample_t * s, 
		       long n) {
  long i;
  for (i = 0; i < n; i++) {
...
void cut_data(complex float * Y, long n,int* data) {
  //int count=0;
  long i;
  double max=0;
  double Yabs[n];
